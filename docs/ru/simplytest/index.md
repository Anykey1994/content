...
Сайты, созданные в данном сервисе, действительны в течение 24 часов с момента установки.
...
Если вы запустили ручной процесс установки, на этапе настройки подключения к базе данных, в качестве названия базы данных, её пользователя и пароля, используйте значение `XXX`.
