...
**Административный раздел "Содержимое"** содержит список типов содержимого, имеющихся на сайте.
...
По мере включения того или иного функционала вверху будут появляться дополнительные вкладки, содержащие в себе список содержимого данного типа.

На скриношоте выше можно увидеть следующие вкладки:
