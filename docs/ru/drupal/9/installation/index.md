...
- **Региональные настройки**.
  - **Страна по умолчанию**: Данная страна будет автоматически указываться там, где это требуется. Ядро Drupal использует данное значение для работы с форматами дат и чисел. Например, при выборе России, по умолчанию будут использоваться наш формат записи даты: дд.мм.гггг; время будет указываться в 24-часовом формате и т.д.
  - **Часовой пояс по умолчанию**: Данная настройка влияет на то, в соответствии с каким поясом будут отображаться дата и время на сайте. В дальнейшем можно настроить, чтобы пользователи могли выбирать свой часовой пояс, тогда все даты и время будут показываться в соответствии с их часовым поясом.
...
После прохождения всех этапов вас перенаправит на главную страницу вашего нового сайта на Drupal. Вы будете автоматически авторизованы под административным пользователем и сможете приступить к работе.
